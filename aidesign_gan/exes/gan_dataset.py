...
info: str = r"""Selected the dataset at: {}
...
{_usage}
"""
dataset_does_not_exist_info: str = f"\"{_brief_usage}\""r""" cannot find the dataset
Please check if the dataset is present at: {}"""fr"""
{_usage}
"""
dataset_is_not_dir_info: str = f"\"{_brief_usage}\""r""" finds that the dataset is not a directory
